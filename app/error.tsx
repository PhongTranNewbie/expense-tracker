...
/**
 * Route-level Error Boundary for App Router
 * 
 * Catches errors thrown in:
 * - Page components
 * - Layout components (except root layout)
 * - Client components
 * - Server components during rendering
 * 
 * Does NOT catch:
 * - Errors in root layout (use global-error.tsx)
 * - Errors in server actions (handled by try/catch)
    ...
    <div className="mx-auto max-w-2xl px-4 py-16">
      <div className="rounded-lg border border-red-200 bg-red-50 p-8 dark:border-red-900/50 dark:bg-red-950/20">
        ...
        <div className="flex flex-col gap-3 sm:flex-row sm:justify-center">
          <button
            onClick={reset}
            className="rounded-md bg-red-600 px-6 py-2.5 text-sm font-medium text-white transition-colors hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 dark:bg-red-700 dark:hover:bg-red-600 dark:focus:ring-offset-zinc-900"
          >
            Try again
          </button>
          ...
          <a
            href="/"
            className="rounded-md border border-red-300 bg-white px-6 py-2.5 text-center text-sm font-medium text-red-700 transition-colors hover:bg-red-50 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 dark:border-red-800 dark:bg-zinc-900 dark:text-red-300 dark:hover:bg-zinc-800 dark:focus:ring-offset-zinc-900"
          >
            Go to dashboard
          </a>
        </div>
